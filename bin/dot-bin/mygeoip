...
country_string=`mmdblookup              --file ${file_city}    --ip "$cip" country names en 2>/dev/null`
continent_string=`mmdblookup            --file ${file_city}    --ip "$cip" continent names en 2>/dev/null`
